<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  var chartDrowFun = {
    ...
    chartDrow : function(){
        ...
        var s_month = s_month.getFullYear();
        alert(s_month);
        ...
        function drawDashboard() {
          ...
          var dataRow = [];
           ...
           for(var i = 0; i <= 11; i++){ //1월 부터 12월 까지
              ...
              var ratio = rsv_count - sales ; //비율 
   
              dataRow = [new Date(s_month, i), rsv_count, sales , ratio];
              data.addRow(dataRow);
            } 
 
            dataRow = [new Date(s_month, 0), rsv_count, sales , ratio];
            data.addRow(dataRow);
